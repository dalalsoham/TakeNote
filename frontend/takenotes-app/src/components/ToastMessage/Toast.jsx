...
// in this below code this is the supported code. This will be changed after debugging is finished.
  ...
  return (
    ...
    >
      <div
        ...
        } after:absolute after:left-0 after:top-0 after:w-[5px] after:h-full after:rounded-l-lg`}
      >
        <div className="flex items-center gap-3 py-2 px-4">
          <div
            className={`w-10 h-10 flex items-center justify-center rounded-full ${
